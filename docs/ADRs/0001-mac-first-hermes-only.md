...
## Context
Agent Hub Phase 0 / Phase 1 is meant to become a daily-use supervision layer for programmers running Hermes locally. Existing planning docs already constrain the first delivery to a native macOS experience, a single Hermes adapter, and a MenuBar-first workflow focused on task supervision instead of chat.
